...
#    Updated: 2023/04/05 11:30:21 by woumecht         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCP= build_linked_list.c is_there_in_redirection.c is_there_out_redirection.c is_there_heredoc.c handle_quotes.c \
	is_there_append.c ft_uncoted_expaind.c ft_coted_expaind.c build_list_1.c fill_with.c build_list_2.c \
	 expaind_exit_state.c redirection_syntax.c expaind_heredoc.c free_linked_lists.c syntax.c reaper_cmd.c open_heredoc.c\
	 fill_fd.c open_redirection.c add_space_redirection.c all_cases_of_reder.c expaind_it.c reaper_cmd_cases.c fill_with2.c check_ambiguous.c shift_array_of_nullter.c\
